          ...
          <div className={styles.heroContent}>
            ...
            >
              <div className={styles.tagline}>
                <span className={styles.pill}>AI-Powered Workflow Automation</span>
              </div>
              <h1 className={styles.heroTitle}>
                Automate Your Business <span className={styles.gradientText}>10x Faster</span>
              </h1>
              <div className={styles.authorName}>by Siddham Mishra</div>
              <Text className={styles.heroSubtitle} as="p" size="xl" color="secondary">
                Custom automation solutions that eliminate repetitive tasks and supercharge productivity.
              </Text>
              ...
              <div className={styles.heroCtaGroup}>
                <div className={styles.heroMetrics}>
                  ...
                  <div className={styles.heroMetric}>
                    ...
                    <span className={styles.metricLabel}>Integrations</span>
                  </div>
                  <div className={styles.heroMetric}>
                    <span className={styles.metricValue}>24/7</span>
                    <span className={styles.metricLabel}>Automation</span>
                  </div>
                </div>
                ...
                <div className={styles.logosContainer}>
                  ...
                  <div className={styles.companyLogo}>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                      ...
                      <path d="M12 12.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm-4.5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm9 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"></path>
                    </svg>
                    <span>GammaTech</span>
                  </div>
                </div>
            ...
            >
              <div className={styles.heroImageContainer}>
                  ...
                  <div className={styles.nodeRow}>
                    <div className={styles.workflowNode}>
                      <div className={styles.nodeIcon}>
                        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                          <path d="M21 14.5v-2.5c0-1.1-.9-2-2-2h-1v3h-2v-3h-6v3h-2v-3h-1c-1.1 0-2 .9-2 2v2.5c0 .83.67 1.5 1.5 1.5.83 0 1.5-.67 1.5-1.5v-1.5h2v2h6v-2h2v1.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5z"></path>
                          <path d="M10 6h4v2h-4z"></path>
                        </svg>
                      </div>
                      <span>Trigger</span>
                    </div>
                ...
                <div className={styles.floatingElements}>
                  <div className={styles.floatingElement} style={{ top: '10%', left: '20%' }}></div>
                  <div className={styles.floatingElement} style={{ top: '60%', left: '80%' }}></div>
                  <div className={styles.floatingElement} style={{ top: '80%', left: '30%' }}></div>
                </div>
              </div>
            </motion.div>
          </div>
